...
enum llm_tensor {
    ...
    // DFlash draft model tensors
    LLM_TENSOR_DFLASH_FC,           // fc.weight: project concatenated target hidden states
    LLM_TENSOR_DFLASH_HIDDEN_NORM,  // hidden_norm.weight: norm applied after fc projection
};
