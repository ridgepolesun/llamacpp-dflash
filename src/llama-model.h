...
struct llama_model {
    ...
    // DFlash draft model tensors (QWEN3DFLASH)
    struct ggml_tensor * dflash_fc          = nullptr; // fc.weight: [n_embd, n_target_layers * n_embd]
    struct ggml_tensor * dflash_hidden_norm = nullptr; // hidden_norm.weight: [n_embd]
