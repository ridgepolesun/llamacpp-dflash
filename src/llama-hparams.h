...
struct llama_hparams {
    ...
    uint32_t n_dflash_block_size        = 16;  // speculation block size (default 16)
    uint32_t n_dflash_num_target_layers = 0;   // number of target layers fc projects from
    int32_t  dflash_target_layer_ids[8] = {};  // which target layers to extract (max 8)
