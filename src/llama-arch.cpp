...
static const std::map<llm_arch, const char *> LLM_ARCH_NAMES = {
    ...
    { LLM_ARCH_QWEN3DFLASH,      "qwen3dflash"      },
    { LLM_ARCH_PHI2,             "phi2"             },
    { LLM_ARCH_PHI3,             "phi3"             },
...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_DFLASH_BLOCK_SIZE,         "%s.dflash_block_size"         },
    { LLM_KV_DFLASH_NUM_TARGET_LAYERS,  "%s.dflash_num_target_layers"  },
    { LLM_KV_DFLASH_TARGET_LAYER_IDS,   "%s.dflash_target_layer_ids"   },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    // DFlash draft model tensors (global, not per-layer)
    { LLM_TENSOR_DFLASH_FC,                              "dflash.fc" },
    { LLM_TENSOR_DFLASH_HIDDEN_NORM,                     "dflash.hidden_norm" },
...
static std::set<llm_tensor> llm_get_tensor_names(llm_arch arch) {
    switch (arch) {
        ...
        case LLM_ARCH_QWEN3DFLASH:
            // DFlash draft model: no TOKEN_EMBD or OUTPUT (borrowed from target model)
            return {
                LLM_TENSOR_OUTPUT_NORM,        // norm.weight
                LLM_TENSOR_DFLASH_FC,          // fc.weight
                LLM_TENSOR_DFLASH_HIDDEN_NORM, // hidden_norm.weight
                LLM_TENSOR_ATTN_NORM,          // layers.N.input_layernorm
                LLM_TENSOR_ATTN_Q,
                LLM_TENSOR_ATTN_Q_NORM,
                LLM_TENSOR_ATTN_K,
                LLM_TENSOR_ATTN_K_NORM,
