...
class Keys:
    ...
    class LLM:
        ...
        # DFlash draft model parameters
        DFLASH_BLOCK_SIZE                 = "{arch}.dflash_block_size"
        DFLASH_NUM_TARGET_LAYERS          = "{arch}.dflash_num_target_layers"
        DFLASH_TARGET_LAYER_IDS           = "{arch}.dflash_target_layer_ids"
...
class MODEL_TENSOR(IntEnum):
    ...
    # dflash draft model
    DFLASH_FC          = auto() # qwen3dflash: linear projection from target hidden states
    DFLASH_HIDDEN_NORM = auto() # qwen3dflash: norm applied after fc projection
    # lfm2 audio
...
MODEL_ARCH_NAMES: dict[MODEL_ARCH, str] = {
    ...
    MODEL_ARCH.QWEN3DFLASH:      "qwen3dflash",
...
TENSOR_NAMES: dict[MODEL_TENSOR, str] = {
    ...
    # dflash draft model (global tensors, no {bid})
    MODEL_TENSOR.DFLASH_FC:                 "dflash.fc",
    MODEL_TENSOR.DFLASH_HIDDEN_NORM:        "dflash.hidden_norm",
}
...
MODEL_TENSORS: dict[MODEL_ARCH, list[MODEL_TENSOR]] = {
    ...
    MODEL_ARCH.QWEN3DFLASH: [
        # DFlash draft model - no TOKEN_EMBD or OUTPUT (borrows from target model)
        MODEL_TENSOR.OUTPUT_NORM,      # norm.weight (final output norm)
        MODEL_TENSOR.DFLASH_FC,        # fc.weight (global: target hidden projection)
        MODEL_TENSOR.DFLASH_HIDDEN_NORM, # hidden_norm.weight (global: norm after fc)
        MODEL_TENSOR.ATTN_NORM,        # layers.N.input_layernorm.weight
        MODEL_TENSOR.ATTN_Q,           # layers.N.self_attn.q_proj.weight
        MODEL_TENSOR.ATTN_Q_NORM,      # layers.N.self_attn.q_norm.weight
        MODEL_TENSOR.ATTN_K,           # layers.N.self_attn.k_proj.weight
        MODEL_TENSOR.ATTN_K_NORM,      # layers.N.self_attn.k_norm.weight
        MODEL_TENSOR.ATTN_V,           # layers.N.self_attn.v_proj.weight
        MODEL_TENSOR.ATTN_OUT,         # layers.N.self_attn.o_proj.weight
        MODEL_TENSOR.FFN_NORM,         # layers.N.post_attention_layernorm.weight
        MODEL_TENSOR.FFN_GATE,         # layers.N.mlp.gate_proj.weight
        MODEL_TENSOR.FFN_DOWN,         # layers.N.mlp.down_proj.weight
        MODEL_TENSOR.FFN_UP,           # layers.N.mlp.up_proj.weight
    ],
    MODEL_ARCH.PLAMO: [
        MODEL_TENSOR.TOKEN_EMBD,
        MODEL_TENSOR.OUTPUT_NORM,
